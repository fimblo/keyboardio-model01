...
KEYMAPS(
  ...
  (Key_Escape,  Key_1, Key_2, Key_3, Key_4, Key_5, ___,
   ...
   Key_LeftShift, ___, Key_X, Key_C, ___, ___, Key_LeftGui,
   Key_Spacebar, ___, Key_LeftAlt, Key_LeftShift,
   ShiftToLayer(FUNCTION),
   
   ___, Key_6, Key_7, Key_8, Key_9,  Key_0,  LockLayer(GAMING),
  ...
  (___,      Key_F1,           Key_F2,      Key_F3,     Key_F4,        Key_F5,           Key_CapsLock,
   ...
   Key_F24,          Consumer_Mute,          Consumer_VolumeDecrement, Consumer_VolumeIncrement, ___,             Key_Backslash,    Key_Pipe,
   ___, ___, Key_Enter, ___,
   ___)
)

//  Key_PcApplication <- was on butterfly key 
// KEYMAPS(
...
KALEIDOSCOPE_INIT_PLUGINS(
  ...
  // Applying only the solidYellow led effect
  solidYellow,
